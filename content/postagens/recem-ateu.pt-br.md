...
automáticas ou objetos de pequeno porte.
As críticas são de que os dados contém viés e não são bem analisados.
Mesmo que aparentemente não haja viés intencional, os efeitos são
relativamente discretos, apesar de homogêneos.
...
cenário fala mais sobre o relacionamento do ser humano com a
estatística, e nosso mal uso dela. Para um médico oncologista, como
